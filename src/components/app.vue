    ...
    <f7-panel left cover theme-dark>
      <f7-view>
        <f7-page>
          ...
          <f7-list>
            <f7-list-item link="/singin/" view=".view-main" panel-close title="Sing in"></f7-list-item>
            <f7-list-item link="/singup/" view=".view-main" panel-close title="Sing Up"></f7-list-item>
          </f7-list>
        </f7-page>
      </f7-view>
    </f7-panel>
...
var firebaseConfig = {
  apiKey: "AIzaSyCjGahxy-9LeScqGLjOzKXpitR9mZxtohg",
  authDomain: "whatchat-73a03.firebaseapp.com",
  databaseURL: "https://whatchat-73a03.firebaseio.com",
  projectId: "whatchat-73a03",
  storageBucket: "whatchat-73a03.appspot.com",
  messagingSenderId: "655924366281",
  appId: "1:655924366281:web:dea6a8d840d890a1cf3618",
  measurementId: "G-B4DY5QPT86"
};
// Initialize Firebase
