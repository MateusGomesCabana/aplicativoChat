<template>
  <f7-page name="Sing Up">
    <f7-navbar title="Sing Up" back-link="Back"></f7-navbar>
    <!-- no-hairlines -->
    <div class="wrapper">
        <img class="image--cover"   :src="imageUrl" alt="">
    ...
    <f7-block>
      <f7-button outline login-screen-close @click="singUp">Cadastrar</f7-button>
      <div style="text-align:center;">
        <f7-link >Cadastre-se</f7-link>
      </div>
    </f7-block>
  </f7-page>
</template>
...
export default {
  ...
  methods: {
    ...
    singUp(){
        ...
        this.$store.dispatch('singUp',payload)
